    ...
    def on_merge_cycles(self):
        ...
        def _merge_worker():
            ...
            return merge_cycles_to_ome_tiff(
                ...
                registration_algorithm=str(cfg.get("registration_algorithm") or "tiled_rigid"),
                global_translation_only=bool(cfg.get("global_translation_only") or False),
                ...
                elastic_touchup=bool(cfg.get("elastic_touchup") if cfg.get("elastic_touchup") is not None else False),
                elastic_touchup_tile_size=max(64, int(cfg.get("elastic_touchup_tile_size") or 2048)),
                elastic_touchup_bspline_spacing=max(4, int(cfg.get("elastic_touchup_bspline_spacing") or 50)),
                elastic_touchup_max_iterations=max(1, int(cfg.get("elastic_touchup_max_iterations") or 10)),
                elastic_touchup_max_step_length=max(0.01, float(cfg.get("elastic_touchup_max_step_length") or 1.0)),
                elastic_touchup_rigid_max_shift=max(1.0, float(cfg.get("elastic_touchup_rigid_max_shift") or 512.0)),
